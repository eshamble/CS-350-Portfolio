...
class TemperatureMachine(StateMachine):
    ...
    def updateLights(self):
        ...
        ##
        ## update the status of the lights in our thermostat circuit.
        if self.getFahrenheit() >= self.setPoint and self.current_state.id == "heat":
            redLight.on()
            blueLight.off()
        elif self.getFahrenheit() < self.setPoint and self.current_state.id == "heat":
            redLight.pulse()
            blueLight.off()
        elif self.getFahrenheit() <= self.setPoint and self.current_state.id == "cool":
            redLight.off()
            blueLight.on()
        elif self.getFahrenheit() > self.setPoint and self.current_state.id == "cool":
            redLight.off()
    ...
    def setupSerialOutput(self):
        ...
        output = self.current_state.id + ", " + str(self.getFahrenheit()) + "F, " + str(self.setPoint) + "F"
    ...
    def manageMyDisplay(self):
        ...
        while not self.endDisplay:
            ...
            if(altCounter < 6):
                lcd_line_2 = str(self.getFahrenheit()) + " °F"
    
                altCounter = altCounter + 1
            else:
                lcd_line_2 = self.setupSerialOutput()
